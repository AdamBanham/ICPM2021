...
To ensure that the same tublar version which was used in [x] was produced, this ![readme.md](process/out/procedures/readme.md) contains checksums for each log.
